    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/myweb/hong">My First Web</a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                   <li>
                    ...
                    <li>
                    	<a href="/myweb/user/user_mypage.jsp" style="color:red">MaPage</a>
                    </li>
                    <%} %>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-6 text-center">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="img-responsive img-full" src="/myweb/img/2.jpg">
                            </div>
                            <div class="item">
                ...
                <div class="col-lg-6 text-center">
                    ...
                    <hr>
                    <h3>화보 영상</h3>
                    <iframe width="100%" height="372px" src="https://www.youtube.com/embed/1C6dcnVQjSM?autoplay=1&amp;loop=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <div class="inner" align="center">
                        <img class="img-responsive img-center" src="/myweb/img/intro.jpg" alt="">
                        <hr class="visible-xs">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; By JO 2024.04.13~</p>
                </div>
            </div>
        </div>
    </footer>
